...
process.env.BROWSERSLIST_CONFIG =
  process.env.BROWSERSLIST_CONFIG ||
  require.resolve('../../configs/.browserslistrc');
...
const compileServer = spawn('node', [path.join(__dirname, './server')], {
  stdio: 'inherit',
});
const compileClient = spawn('node', [path.join(__dirname, './client')], {
  stdio: 'inherit',
});
